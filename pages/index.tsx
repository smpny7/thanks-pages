      ...
      <div className="absolute bottom-0 left-0 right-0 top-0 flex flex-col">
        <div className="grow px-8 w-full max-w-[1400px] mx-auto flex items-center">
          <div className="w-full pt-10">
            <h1
              className="text-white/90 tracking-wider text-[40px] sm:text-[50px] md:text-[60px] font-bold"
            ...
            <div className="mt-24 flex justify-end items-center">
              ...
              <p
                className="text-white/90 tracking-wider sm:text-2xl md:text-[28px] text-right font-bold !leading-7 sm:!leading-10 md:!leading-[3rem]"
                style={{ textShadow: "0 0 15px black" }}
              >
                たくさんのご来場
                <br />
